...
class ROBERTAClassifier(torch.nn.Module):
    def __init__(self, BERT_MODEL_NAME):
        ...
        self.d1 = torch.nn.Dropout(p = 0.3, inplace=False) #funcion de union del modelo pre entrenado con la red neuronal de lcasificación.
        self.l1 = torch.nn.Linear(768, 384)
        self.act1 = torch.nn.Sigmoid()
        self.d2 = torch.nn.Dropout(p=0.3, inplace=False)
        self.l3 = torch.nn.Linear(384, 64)
